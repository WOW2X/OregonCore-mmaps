...
void World::LoadConfigSettings(bool reload)
{
    ...
    // Pathfinding related.
    m_configs[CONFIG_ENABLE_PATHFINDING] = sConfig.GetBoolDefault("pathing.enable", true);
    std::string ignoreMapIds = sConfig.GetStringDefault("pathing.ignoreMapsIds", "");
    MMAP::MMapFactory::preventPathfindingOnMaps(ignoreMapIds.c_str());
    sLog.outString("WORLD: Pathfinding %sabled", m_configs[CONFIG_ENABLE_PATHFINDING] ? "en" : "dis");
